...
### Can I run DClaw API without Kubernetes?

Yes, for local development:

```bash
cd dclaw-api/frontend && npm run dev
cd dclaw-api/backend && uvicorn dclaw_api.main:app --reload
```

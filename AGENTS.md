...
**DClaw API** is a vertical SaaS application built on the DClaw Stack.

- **Backend Port:** `8027` (FastAPI)
- **Frontend Port:** `3027` (Next.js)
- **Database:** `dclaw_api` (PostgreSQL)
...
- **Frontend:** `node:20-alpine`, port `3027`
